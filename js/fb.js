function SocialPlugin() {
        ...
        "" != window.location.host && n(function (e) {
            e || (window.fbAsyncInit = function () {
                "undefined" != typeof FB && FB && (FB.init({
                    ...
                    e.search("http://news.zing.vn/share/link.aspx") >= 0 || ($(n).parents(".btnSocial").css("overflow", "visible"), t.showFanpagePopup())
    ...
    this.showFanpagePopup = function () {
        ...
        return "undefined" != typeof FB && FB ? t.isFBLogin && t.publish_permission ? void FB.api("me/zing_news:comment", "post", {
            article: n,
            message: e,
